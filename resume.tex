...
\vspace{3mm}
	\headerquotestyle{Leader, People Manager, Entrepreneur and Full-Stack Engineer with 12+ years of experience. Skilled in leading high-performance teams and solving complex problems with a strong product-building mindset. Thrives in ambiguous environments, adept at driving results and thinking outside-the-box. Known for a fast-paced, builder mindset.} \\
...
\cventry
	...
	{Meta}
	{London, UK | Spain, Fully-Remote}
	{Nov 2018 – Present}
	{\begin{cvitems}
		\item {\textbf{Established, led and supported the first fully-remote team} of multicultural high-performing software engineers across EMEA for the Business Products Engineering Organization}
...
\begin{cventries}
	...
	{\def\arraystretch{1.15}{\begin{tabular}{ l l }
		...
		Spoken Languages:  & {\skill{ English (Native Proficiency), Portuguese (Native Proficiency), French (Working Proficiency)}} \\
		\end{tabular}}}
	{}
	{}
	{}
